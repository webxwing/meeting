<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeetingAddItemsS.aspx.cs" Inherits="meeting.Meeting.MeetingAddItemsS" ValidateRequest="false" %>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form id="addItemForm" class="form-horizontal" action="MeetingAddItemsS.aspx" method="post" runat="server">
