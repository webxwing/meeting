<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeetingAddItems.aspx.cs" Inherits="meeting.Meeting.MeetingAddItems" %>
        ...
        <div class="div_wraper">
            ...
            <div class="easyui-panel" title="添加议程" style="width:700px;height:auto;padding:10px;background:#fafafa;">
                ...
                <div class="div_row">
                    ...
                    <textarea rows="" name="item_content" class="textarea_abstruct"></textarea>
                </div>
                <div class="div_row">
                    <label for="item_time">耗 时：</label>&nbsp;&nbsp;
                    <input class="easyui-numberspinner" data-options="min:1,max:999,required:true" name="item_time" style="width:80px;"/> 分钟
                </div>
                <div class="div_row">
                    <label >附 件：</label>&nbsp;&nbsp;
