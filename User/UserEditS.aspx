<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEditS.aspx.cs" Inherits="meeting.User.UserEditS" %>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form id="EditUserForm" class="form-horizontal" action="UserEditS.aspx" method="post" runat="server">
                            <asp:HiddenField ID="hfU_id" runat="server" />
                            <div class="form-group has-success">
                                <label class="col-sm-2 control-label">用户名</label>
                                <div class="col-sm-10">
                                    <input type="text" id="u_username" name="u_username" class="form-control disabled" runat="server" disabled="disabled" />
                                </div>
                            </div>
                            <div class="form-group has-success">
                                <label class="col-sm-2 control-label">原始密码</label>
                                <div class="col-sm-10">
                                    <input type="password"  class="form-control" name="u_old_password" id="u_old_password" runat="server" />
                                </div>
                            </div>
                            <div class="form-group has-success">
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio i-checks">
                                        <label>
                                            <input type="radio" value="user" name="actor" runat="server"/> <i></i> 普通用户</label>
                                    </div>
                                    <div class="radio i-checks">
                                        <label>
